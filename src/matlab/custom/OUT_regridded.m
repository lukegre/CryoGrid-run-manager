...
% L Gregor differences:
% 1) create .PARA.out_file with placeholder for date
% 2) tag automatically added to file name in finalize_init
% 3) string tags now supported, not just numeric
% 4) run_nam/"output"/run_name_tag_date.mat - output added as extra folder
% 5) file name shown when saved
%========================================================================
...
classdef OUT_regridded < matlab.mixin.Copyable
    ...
    methods
        ...
        function out = finalize_init(out, tile)
            ...
            out.PARA.file_out = fullfile([tile.PARA.result_path '/' tile.PARA.run_name '/output/' tile.PARA.run_name tag '%s.mat']);
        ...
        function out = store_OUT(out, tile)
            ...
            if t>=out.OUTPUT_TIME
                ...
                if t>=out.SAVE_TIME
                    ...
                    % moved tag processing to finalize_init
                    sname = sprintf(out.PARA.file_out, datestr(t, 'yyyymmdd'));
                    save(sname, 'CG_out')
