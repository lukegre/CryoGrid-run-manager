%========================================================================
% CryoGrid TILE class TILE_1D_ensemble
% TILE class designed for multi-physics simulations with a stratigraphy of
% connected CryoGrid stratigraphy classes.
% based on the TILE_1D_standard class so that init_steady_state_class is defined
%  in the TILE_BUILDER class (which is not the case for the standard TILE_1D_ensemble).

% Biggest difference from TILE_1D_standard is in build_tile_update_forcing_out (~550)
% do a diff with the two files to see the difference
% Only working build_tile classes are: build_tile_new_init, build_tile_update_forcing_out
% since these are the ones that I need
% S. Westermann, Dec 2020
% L. Gregor, May 2025
%========================================================================
classdef TILE_1D_ensemble2 < matlab.mixin.Copyable
        ...
        function check_if_PARA_assigned(tile)
            ...
            elseif strcmp(tile.PARA.builder, 'new_init_steady_state')
                parameters = {'domain_depth'; 'forcing_class'; 'forcing_class_index'; 'grid_class'; 'grid_class_index'; 'out_class'; ...
                    ...
                    'T_first_cell'; 'start_depth_steady_state'; 'DA_classes'; 'DA_classes_index'; 'ensemble_class'; 'ensemble_class_index'};
       ...
       function tile = param_file_info(varargin)
            ...
            if strcmp(option, 'new_init')
                ...
                parameters = {'latitude'; 'longitude'; 'altitude'; 'domain_depth'; 'area'; 'forcing_class'; 'forcing_class_index'; 'grid_class'; 'grid_class_index'; 'out_class'; ...
                    'out_class_index'; 'strat_classes_class'; 'strat_classes_class_index'; 'strat_statvar_class'; 'strat_statvar_class_index'; 'lateral_class'; ...
                    'lateral_class_index'; 'lateral_IA_classes'; 'lateral_IA_classes_index'; 'ensemble_class'; 'ensemble_class_index'};
            ...
            elseif strcmp(option, 'new_init_steady_state')
                parameters = {'latitude'; 'longitude'; 'altitude'; 'domain_depth'; 'area'; 'forcing_class'; 'forcing_class_index'; 'grid_class'; 'grid_class_index'; 'out_class'; ...
                    'out_class_index'; 'strat_classes_class'; 'strat_classes_class_index'; 'strat_statvar_class'; 'strat_statvar_class_index'; 'lateral_class'; ...
                    'lateral_class_index'; 'lateral_IA_classes'; 'lateral_IA_classes_index'; 'init_steady_state_class'; 'init_steady_state_class_index';...
                    'T_first_cell'; 'start_depth_steady_state'; 'ensemble_class'; 'ensemble_class_index'};
                for i=1:size(parameters,1)
                    tile.PARA.(parameters{i,1})=[];
                end
